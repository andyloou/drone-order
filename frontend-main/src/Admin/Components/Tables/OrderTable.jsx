...
const OrderTable = () => {
    ...
    const startLat = 21.028511; // lay của người dùng
    const startLng = 105.804817;
    const endLat = 20.998228;
    const endLng = 105.789925; // lấy từ cơ sở dữ liệu.
    ...
    const toggleTracking = (order) => {
        ...
        setFlyingPathPositions([...flyingPathPositions, {
            lat: order.receiveLocation.lat,
            lng: order.receiveLocation.long
        }])
                    ...
                    <Row className="mt-3">
                        <Col>
                            <div style={{textAlign: 'right'}}>
                                ...
                                <Button style={{margin: '5px'}} color="primary" onClick={submitSetupDelivery}>Confirm
                                    and Save</Button>
                            </div>
                        </Col>
                    </Row>
            ...
            <Modal size="xl" fullscreen="xl" centered isOpen={modalReceiveLocation} toggle={toggleReceiveLocation}>
                <ModalBody>
                    <Row>
                        <Col>
                            <Row className="mt-2">
                                <div style={{fontSize: 'large', color: '#1E73F3', fontWeight: '500'}}>Setup Order
                                    Deliver
                                </div>
                            </Row>
                                ...
                                <Col>
                                    <div style={{textAlign: 'center', marginTop: '20px'}}>
                                        <iframe
                                            width="560"
                                            height="315"
                                            src="https://www.youtube.com/embed/c1TJXZRe760"
                                ...
                                >
                                    <option value=""></option>
                                    {
                                        receiveLocations ? receiveLocations.map(location =>
                                            <option
                                                value={location._id}>{location.name} - {calculateDistance(location, orderSelect).toFixed(2)} km</option>
                                        ) : <></>
                                    }
                                </Input>
                            </Row>
                        ...
                        <Col>
                            ...
                            <div>
                                ...
                                <MyMapComponent startLat={startLat} startLng={startLng} endLat={endLat}
                                                endLng={endLng}/>
                            </div>
                        </Col>
                    </Row>
            ...
            <Modal size="xl" fullscreen="xl" centered isOpen={modalTracking} toggle={toggleTracking}>
                <ModalBody>
                    <Row>
                        <Col>
                            <Row className="mt-2">
                                <div style={{fontSize: 'large', color: '#1E73F3', fontWeight: '500'}}>Tracking Order
                                    Deliver
                                </div>
                            </Row>
                            ...
                            <Row>
                                <Col>
                                    <div style={{textAlign: 'center'}}>
                                        <Button style={{margin: '5px', textAlign: 'center'}} color="primary"
                                                onClick={cancelTracking}>Close Tracking</Button>
                                    </div>
                                </Col>
                            </Row>
                        </Col>
                                                ...
                                                <div>
                                                    <Table size="small" aria-label="purchases">
                                                        <TableHead>
                                                            <TableRow>
                                                                ...
                                                                <TableCell align="left"
                                                                           sx={{color: "#1976d2", fontWeight: 'bold'}}>Product
                                                                    Name</TableCell>
                                                        ...
                                                        <TableBody>
                                                            ...
                                                            {order.status === "In Progress" ?
                                                                <Button onClick={() => toggleReceiveLocation(order)}
                                                                        color="primary" className="mt-2 mb-2">
                                                                    Setup Delivery
                                                                </Button>
                                                                :
                                                                <>
                                                                    {order.status !== "Complete" ?
                                                                        <>
                                                                            ...
                                                                            <Button
                                                                                onClick={() => completeDeliveryStatus(order)}
                                                                                color="primary"
